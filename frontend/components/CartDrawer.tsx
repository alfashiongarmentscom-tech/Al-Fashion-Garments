...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer Panel */}
      <div 
        className={`fixed top-0 right-0 h-full w-full sm:w-[450px] bg-white z-[60] transform transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] flex flex-col ${isCartOpen ? 'translate-x-0 shadow-2xl' : 'translate-x-full shadow-none'}`}
      >
        <button 
          onClick={closeCart}
